...
class Setup:
    ...
    def initDatabase(self):
        ...
        self.run_query('CREATE TABLE IF NOT EXISTS "accounts_errors" ("id"	INTEGER NOT NULL, "account_id" INTEGER NOT NULL, "error" TEXT NOT NULL, "last_used" INTEGER NOT NULL, PRIMARY KEY("id" AUTOINCREMENT));')
        self.run_query('CREATE TABLE IF NOT EXISTS "campaigns" ("id" INTEGER NOT NULL UNIQUE, "name" TEXT NOT NULL, "group" TEXT NOT NULL, "total_users" INTEGER NOT NULL, "completed_users" INTEGER NOT NULL, "failed_users" INTEGER NOT NULL, "last_used" INTEGER NOT NULL, "seconds" INTEGER NOT NULL, "pause" INTEGER NOT NULL, "status" INTEGER NOT NULL,PRIMARY KEY("id" AUTOINCREMENT));')
        self.run_query('CREATE TABLE IF NOT EXISTS "campaigns_accounts" ("id" INTEGER NOT NULL UNIQUE, "campaign_id" INTEGER NOT NULL, "account_id" INTEGER NOT NULL, "last_used" INTEGER NOT NULL, "joined" INTEGER NOT NULL, "status" INTEGER NOT NULL, PRIMARY KEY("id" AUTOINCREMENT));')
